...
export default function RegionAnalytics({ rentals }) {
  ...
  const RegionTable = ({ title, color, data, type }) => (
    <div style={styles.card}>
      <h3 style={{ margin: "0 0 12px", fontSize: 14, color: color }}>{title} — {label}</h3>
      <div style={{ 
        overflowX: "auto", 
          ...
          <tbody>
            {data.map((region, index) => (
              <tr key={region.region} style={{ borderBottom: "1px solid #f0f0f0" }}>
                ...
                <td style={{ padding: "10px 12px", textAlign: "right", color: color, fontWeight: 500 }}>
    ...
    <div style={{ marginBottom: 40 }}>
      ...
      <div style={{ ...styles.card, marginBottom: 20 }}>
        ...
        <div style={{ overflowX: "auto", WebkitOverflowScrolling: "touch" }}>
          <div style={{ minWidth: isMobile ? 600 : "100%", height: 400 }}>
      ...
      <div style={{ 
        ...
        <RegionTable 
          title="🏆 Most Expensive Regions" 
          color="#c0392b" 
          data={getTopRegions(activeBed)}
          type="expensive"
        />
        <RegionTable 
          title="💰 Most Affordable Regions" 
          color="#27ae60" 
          data={getBottomRegions(activeBed)}
          type="affordable"
        />
      </div>
    </div>
